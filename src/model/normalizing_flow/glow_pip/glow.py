...
from src.model.normalizing_flow.glow_pip.utils import HelperModule
from src.model.normalizing_flow.glow_pip.actnorm import ActNorm
from src.model.normalizing_flow.glow_pip.coupling import AffineCoupling, AdditiveCoupling
from src.model.normalizing_flow.glow_pip.conv import InvConv
...
class FlowBlock(HelperModule):
    def build(self,
        ...
        if split:
            self.prior = nn.Conv2d((nb_channels * squeeze_rate ** 2) // 2, nb_channels * squeeze_rate ** 2, 3,
                                   padding=1)
